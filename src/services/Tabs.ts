...
export class TabsQueryError extends Schema.TaggedError<TabsQueryError>()("TabsQueryError", {
  cause: Schema.Defect()
}) {}

export class TabCreateError extends Schema.TaggedError<TabCreateError>()("TabCreateError", {
  url: Schema.String,
  cause: Schema.Defect()
}) {}

export class Tabs extends Context.Service<Tabs, {
  readonly queryUrlCandidates: Effect.Effect<ReadonlyArray<unknown>, TabsQueryError>
